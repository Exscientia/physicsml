...
class MeanVarANIDataModuleConfig(DataModuleConfig):
...
@dataclass(config=ConfigDict)
class MeanVarANIModelConfig(LightningConfig):
    ...
    datamodule: MeanVarANIDataModuleConfig = field(
        default_factory=MeanVarANIDataModuleConfig,
    )
