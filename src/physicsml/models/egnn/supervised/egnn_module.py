...
from physicsml.models.egnn.supervised.default_configs import EGNNModelConfig
from physicsml.models.utils import make_mlp


class PooledEGNNModule(PhysicsMLModuleBase):
    """
    ...
    def forward(
        ...
        if self.jitter is not None:
            data["coordinates"] = data["coordinates"] + self.jitter * torch.randn_like(
                data["coordinates"],
            )
