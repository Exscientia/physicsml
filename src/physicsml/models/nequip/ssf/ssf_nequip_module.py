...
from physicsml.models.nequip.ssf.default_configs import SSFNequipModelConfig
from physicsml.models.nequip.ssf.ssf_nequip_utils import SSFNequip


class PooledSSFNequipModule(PhysicsMLModuleBase):
    """
    Class for pooled ssf nequip model
    """

    model_config: SSFNequipModelConfig
