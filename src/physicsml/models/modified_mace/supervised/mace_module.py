...
from physicsml.models.modified_mace.modules.modified_mace import ModifiedMACE, PooledReadoutHead, ReadoutHead
from physicsml.models.modified_mace.supervised.default_configs import ModifiedMACEModelConfig
...
class PooledMACEModule(PhysicsMLModuleBase):
    ...
    model_config: ModifiedMACEModelConfig
