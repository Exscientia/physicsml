...
from physicsml.models.mace.mean_var.default_configs import MeanVarMACEModelConfig
from physicsml.models.mace.modules.mace import MACE, PooledReadoutHead, ReadoutHead


class PooledMeanVarMACEModule(PhysicsMLModuleBase):
    """
    Class for pooled mace model
    """

    model_config: MeanVarMACEModelConfig
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if model_config.datamodule.y_graph_scalars is not None:
            ...
            raise ValueError("Must specify 'y_gaph_scalars' for mean var models.")
