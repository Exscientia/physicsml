...
def test_training_tensor_net_energy_forces_charges(featurised_ani1x_atomic_nums):
    (
        dataset_feated,
        x_features,
    ...
    model_config = {
        ...
        "config": {
            ...
            "embedding_mlp_hidden_dims": [6],
            "interaction_mlp_hidden_dims": [6, 6],
            "scalar_output_mlp_hidden_dims": [6, 6],
    ...
    assert "tensor_net_model::wb97x_dz.hirshfeld_charges" in preds.keys()
    assert len(preds) == 3
