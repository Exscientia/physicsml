...
from openeye.oechem import OEMol, OEWriteMolToBytes, oemolistream


@pytest.fixture()
def gdb9_dataset():
    mols_iterator = oemolistream("tests/data/gdb9.sdf").GetOEGraphMols()
    ...
    for mol, (_index, labels) in zip(mols_iterator, df_gdb9.iterrows()):
        ...
        example_dict["mol"] = OEWriteMolToBytes(".oeb", mol)
